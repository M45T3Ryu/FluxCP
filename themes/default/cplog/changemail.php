...
<h2><?php echo htmlspecialchars(Flux::message('DSCPLogCE1')) ?></h2>
<p class="toggler"><a href="javascript:toggleSearchForm()"><?php echo htmlspecialchars(Flux::message('DSCPLogCE2')) ?></a></p>
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	<?php echo $this->moduleActionFormInputs($params->get('module'), $params->get('action')) ?>
	<p>
		<label for="use_request_after"><?php echo htmlspecialchars(Flux::message('DSCPLogCE3')) ?></label>
	...
	<p>
		<label for="use_change_after"><?php echo htmlspecialchars(Flux::message('DSCPLogCE4')) ?></label>
...
<table class="horizontal-table">
	<tr>
		<th><?php echo $paginator->sortableColumn('log.account_id', htmlspecialchars(Flux::message('DSCPLogCE15'))) ?></th>
		<th><?php echo $paginator->sortableColumn('userid', htmlspecialchars(Flux::message('DSCPLogCE16'))) ?></th>
		<th><?php echo $paginator->sortableColumn('old_email', htmlspecialchars(Flux::message('DSCPLogCE17'))) ?></th>
		<th><?php echo $paginator->sortableColumn('new_email', htmlspecialchars(Flux::message('DSCPLogCE18'))) ?></th>
		<th><?php echo $paginator->sortableColumn('request_date', htmlspecialchars(Flux::message('DSCPLogCE19'))) ?></th>
		<th><?php echo $paginator->sortableColumn('request_ip', htmlspecialchars(Flux::message('DSCPLogCE20'))) ?></th>
		<th><?php echo $paginator->sortableColumn('change_date', htmlspecialchars(Flux::message('DSCPLogCE21'))) ?></th>
		<th><?php echo $paginator->sortableColumn('change_ip', htmlspecialchars(Flux::message('DSCPLogCE22'))) ?></th>
	</tr>
	...
	<tr>
		...
		<td>
			...
			<?php else: ?>
				<span class="not-applicable"><?php echo htmlspecialchars(Flux::message('DSCPLogCE11')) ?></span>
			<?php endif ?>
		</td>
		<td>
		...
		<td>
			...
			<?php else: ?>
				<span class="not-applicable"><?php echo htmlspecialchars(Flux::message('DSCPLogCE12')) ?></span>
			<?php endif ?>
		</td>
		<td>
...
<?php else: ?>
<p><?php echo htmlspecialchars(Flux::message('DSCPLogCE13')) ?> <a href="javascript:history.go(-1)"><?php echo htmlspecialchars(Flux::message('DSCPLogCE14')) ?></a>.</p>
<?php endif ?>