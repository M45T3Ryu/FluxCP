...
<h2><?php echo htmlspecialchars(Flux::message('DSCharCSlot1')) ?></h2>
...
<form action="<?php echo $this->urlWithQs ?>" method="post" class="generic-form">
	...
	<table class="generic-form-table">
		<tr>
			<th><label><?php echo htmlspecialchars(Flux::message('DSCharCSlot2')) ?></label></th>
			<td><div><?php echo htmlspecialchars($char->name) ?></div></td>
			<td></td>
		</tr>
		<tr>
			<th><label for="slot"><?php echo htmlspecialchars(Flux::message('DSCharCSlot3')) ?></label></th>
			...
			<td><p><?php echo htmlspecialchars(Flux::message('DSCharCSlot4')) ?> <?php echo (int)$server->maxCharSlots ?>.</p></td>
		</tr>
		<tr>
